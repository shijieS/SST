...
parser.add_argument('--result_root', default="/media/ssm/seagate/weights/UA-DETRAC/0721-E25-M80-G30-TestSet-test", help='folder with result files')
parser.add_argument('--configure_str', default="0_0_0_0_3_3", help="The configure string")
parser.add_argument('--save_folder', default="/media/ssm/seagate/weights/UA-DETRAC/0721-E25-M80-G30-TestSet-format", help='folder which needed to be extracted to')
