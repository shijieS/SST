...
mot17_save_folder = '/media/ssm/data/dataset/mot-challenge/mot17/logs/20190306-ssj-sst-replace'
...
def init_train_mot17():
    ...
    config['log_folder'] = '/media/ssm/data/dataset/mot-challenge/mot17/logs/20190306-dan-remove-compress/logs'
    config['save_folder'] = '/media/ssm/data/dataset/mot-challenge/mot17/logs/20190306-dan-remove-compress/weights'
    config['save_images_folder'] = '/media/ssm/data/dataset/mot-challenge/mot17/logs/20190306-dan-remove-compress/images'
