...
config = {
    ...
    'selector_size': (255, 113, 56),
    'selector_channel':(60, 80, 100),
    'final_net' : {
        '900': [480, 512, 256, 128, 64, 1],
        '1024': []
    },
    'vgg_source' : [15, 25, -1],
...
mot17_save_folder = '/media/ssm/data/dataset/mot-challenge/mot17/logs/20190228-ssj-sst-curtailed'
